...
Реализованы D1 storage и независимые от grammY application-сценарии: доступ, оба способа создания без дубликатов, история, детали, редактирование, удаление и статистика по предыдущему месяцу или произвольному включительному диапазону. Интеграционные тесты используют временную локальную D1; реальная Cloudflare D1 и Telegram пока не проверялись.
